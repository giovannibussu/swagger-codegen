 ...
 */
@Deprecated
public class LinkitCodegen extends LinkitGenerator {

    private static final Logger LOGGER = LoggerFactory.getLogger(LinkitCodegen.class);
    ...
    public static void main(String[] args) {
        ...
        try {
            clientOptInput
                    .opts(clientOpts)
                    .openAPI(openAPI);
            new LinkitCodegen().opts(clientOptInput).generate();
        } catch (Exception e) {
